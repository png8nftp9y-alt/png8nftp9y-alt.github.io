...
jq -e '.counts.tournaments==453 and .counts.matches==47048 and .counts.winnerUnresolved==0 and .counts.conflicts==0' "$OUT/tennis_europe_oop_historical.json" >/dev/null
