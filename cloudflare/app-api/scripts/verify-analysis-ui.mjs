...
assert.ok(!hasSource('Caricamento storico…') && hasSource('if(prepared)renderOpponentHistory(prepared)'), 'prepared opponent profiles must render immediately without a visible loading state');
