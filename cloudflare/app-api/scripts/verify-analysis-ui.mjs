...
assert.ok(hasApiSource('tournament.drawFormat') && hasApiSource('retirementReason') && hasSource('· Rit.') && hasApiSource("?' · Rit.':''"), 'RR payload evidence and API-visible retirement labels must be preserved');
