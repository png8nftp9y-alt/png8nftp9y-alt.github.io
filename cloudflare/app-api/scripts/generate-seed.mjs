...
const sql=['PRAGMA foreign_keys=ON;','DELETE FROM app_match_candidates;','DELETE FROM match_participants;','DELETE FROM tennis_europe_players;','DELETE FROM observed_players;','DELETE FROM app_matches;','DELETE FROM app_tournaments;','DELETE FROM app_players;','DELETE FROM results;','DELETE FROM matches;','DELETE FROM schedules;','DELETE FROM entries;','DELETE FROM tournaments;','DELETE FROM players;'];
