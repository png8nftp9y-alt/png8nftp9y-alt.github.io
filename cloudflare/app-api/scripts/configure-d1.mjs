...
const config={$schema:'./node_modules/wrangler/config-schema.json',name:'courtwatch-app-api',main:'src/index.js',compatibility_date:'2026-08-29',observability:{enabled:true,head_sampling_rate:1},d1_databases:[{binding:'DB',database_name:'courtwatch-app',database_id:id,migrations_dir:'migrations'}],vars:{COURTWATCH_SCHEMA_VERSION:'courtwatch-universal-v1'}};
