...
const [manifest,oop,tournaments,schedules,matches,results]=await Promise.all([
  read('../../dist/v3/universal/manifest.json'),read('seed-tennis-europe-oop/manifest.json'),
