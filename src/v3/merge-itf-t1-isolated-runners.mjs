...
await writeJson('dist/v3/source_itf_draw_audit.json',{version:8,generatedAt,status:pendingTournaments?'itf_t_minus_one_pending_retry':'itf_t_minus_one_batch_complete',summary:{mode:'live_t_minus_1_cumulative_all_sections_merge',isolatedArtifacts:artifactDirs.length,tournamentsChecked:audits.length,completeTournaments,pendingTournaments,cachedSectionsUsed,newSectionsCached,drawRequests,browserFallbacks,browserRecoveries},audit:audits});
console.log(JSON.stringify({isolatedArtifacts:artifactDirs.length,tournamentsChecked:audits.length,completeTournaments,pendingTournaments,cachedSectionsUsed,newSectionsCached,drawRequests,browserFallbacks,browserRecoveries},null,2));
