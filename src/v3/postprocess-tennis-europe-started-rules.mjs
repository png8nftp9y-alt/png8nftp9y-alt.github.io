...
const output = {
  ...data,
  status: String(data.status || 'tennis_europe_acceptance_list_engine_complete') + '_started_draw_rules_applied',
  startedTournamentRule: {
    appliedAt: new Date().toISOString(),
    today: TODAY,
    rule: 'Before tournament start use acceptance labels MD/Q/A. From tournament start keep only players found in official draw data and remove MD/Q/A labels; remove players only present in acceptance list but absent from draws.',
