...
async function acquiredFactsheetMeta(t){
  const endpoint=String(process.env.ITF_FACTSHEET_ACQUISITION_URL||''),token=String(process.env.ITF_FACTSHEET_ACQUIRER_TOKEN||'');
...
export async function factsheetMeta(t){
  ...
  if(!process.env.ITF_FACTSHEET_ACQUISITION_URL)return meta;
